        ...
        <div class="row text-center">
            <div class="col-md-4">
                <div class="card service-card shadow-sm">
                    <img src="https://source.unsplash.com/400x300/?shoes,sport" class="card-img-top" alt="Sewa Sepatu">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card service-card shadow-sm">
                    <img src="https://source.unsplash.com/400x300/?soccer,ball" class="card-img-top" alt="Sewa Bola">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card service-card shadow-sm">
                    <img src="https://source.unsplash.com/400x300/?vest,team" class="card-img-top" alt="Peminjaman Rompi">
                    <div class="card-body">
